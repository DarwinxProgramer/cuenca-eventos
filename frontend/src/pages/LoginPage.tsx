...
import { mockUsers } from '../mocks/eventData';
import { findUserByEmail } from '../mocks/userStorage';
...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Check credentials against mock users first
        let user = mockUsers.find(u => u.email === email && u.password === password);

        // If not found in mock users, check registered users from sessionStorage
        if (!user) {
        ...
        if (user) {
            ...
            localStorage.setItem('cuenca-eventos-user', JSON.stringify(userWithoutPassword));
